        ...
        >
            <Stack maxW={{ md: 550, base: "auto" }}>
                ...
                <Text
                    ...
                    lineHeight={"taller"}
                >
                    We also offer one-on-one sessions with our vetted
                    nutritionists for personalized guidance tailored to your
                    needs. Whether you&apos;re seeking advice on dietary
                    choices, meal planning, or specific health concerns, our
                    experts are here to support you every step of the way. <br></br> Also if
